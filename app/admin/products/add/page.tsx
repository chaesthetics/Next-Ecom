    ...
    <div className="flex flex-col px-3 md:px-10 py-8 md:py-4 h-full overflow-y-scroll">
        ...
        <form action={submitHandler} className="bg-white px-6 md:px-8 py-8 space-y-1 md:space-y-2 md:space-y-4 rounded-xl shadow">
                ...
                <div className="flex flex-col md:flex-row items-start justify-center md:items-start md:justify-start py-2 space-y-4 md:space-y-0 md:space-x-12">
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-col space-y-1 md:space-y-2">
                            ...
                            <input name="name" autoComplete="off" autoCorrect="off" autoCapitalize="off" className="border text-sm md:text-md border-gray-300 w-full focus:outline-none px-2 py-2 rounded-md focus:border-blue-700"/>
                        </div>
           ...
           <hr />
            ...
            <button type="submit" onClick={handleSubmitClick} className={`px-8 py-2 text-sm md:text-md text-white bg-blue-600 hover:bg-blue-800 hover:bg-blue-700 rounded ` + (isSubmitted ?  'disabled bg-blue-800' : '' )}
            >
                {!isSubmitted ? 
                    <span>Add Item</span>
                    :
