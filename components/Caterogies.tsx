...
return(
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 md:gap-y-10">
        <div className="flex justify-center relative hover:cursor-pointer group">
            <div className="relative group">
            <Image height={220} width={220} className="object-contain group-hover:brightness-50 hover:opacity-90 animation-300 duration-200 h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image.jpg" alt="" />
            <p className="group-hover:block animation-300 duration-200 hidden absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl text-white font-bold">OIL</p>
            </div>
        </div>
        ...
        <div className="flex justify-center hover:cursor-pointer group">
            <div className="relative group">
                <Image height={220} width={220} className="object-contain group-hover:brightness-50 hover:opacity-90 animation-300 duration-200 h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="" />
                <p className="group-hover:block animation-300 duration-200 hidden absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl text-white font-bold">SHOE</p>
            </div>
        </div>
        <div className="flex justify-center hover:cursor-pointer group">
            <div className="relative group">
                <Image height={220} width={220} className="object-contain group-hover:brightness-50 hover:opacity-90 animation-300 duration-200 h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-6.jpg" alt="" />
                <p className="group-hover:block animation-300 duration-200 hidden absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl text-white font-bold">CREAM</p>
            </div>
        </div>
        <div className="flex justify-center hover:cursor-pointer group">
            <div className="relative group">
                <Image height={220} width={220} className="object-contain group-hover:brightness-50 hover:opacity-90 animation-300 duration-200 h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-7.jpg" alt="" />
                <p className="group-hover:block animation-300 duration-200 hidden absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl text-white font-bold">POUCH</p>
            </div>
        </div>
        <div className="flex justify-center hover:cursor-pointer group">
